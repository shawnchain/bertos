...
#include "stm32_exti.h"
...
#elif CPU_CM3_STM32F103RB || CPU_CM3_STM32F103RE || CPU_CM3_STM32F100RB || CPU_CM3_STM32F100C4 || CPU_CM3_STM32F102C4 || CPU_CM3_STM32F103C8
	#define GPIO_USART1_TX_PIN	BV(9)
	#define GPIO_USART1_RX_PIN	BV(10)
	#define GPIO_USART2_TX_PIN	BV(2)
	#define GPIO_USART2_RX_PIN	BV(3)
	...
	#define GPIO_I2C1_SDA_PIN	BV(7)
		...
		CPU_CM3_STM32F100C4 || CPU_CM3_STM32F102C4 || CPU_CM3_STM32F103C8
	#define GPIO_I2C1_SCL_PIN	BV(6)
	#define GPIO_I2C1_SDA_PIN	BV(7)
	...
	#error No i2c pins are defined for select cpu
		...
		CPU_CM3_STM32F100RB || CPU_CM3_STM32F100C4 || CPU_CM3_STM32F102C4 || CPU_CM3_STM32F103C8
